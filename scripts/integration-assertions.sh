...
Drive one billable request through the running paired integration stack
...
expected_migrations="$((1 + $(find platform/deploy/migrations -maxdepth 1 -type f -name '*.sql' | wc -l)))"
